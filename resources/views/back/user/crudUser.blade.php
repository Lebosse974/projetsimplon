        ...
        <tbody>
            @foreach ($users as $user)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('user.showUpdate', $user->id) }}"uk-toggle><i
                                class="mx-2 fa-solid fa-pen hover:cursor-pointer"></i></a>
                        <a href="{{-- #modal-sections --}}{{ route('user.delete', $user->id) }}" uk-toggle><i
                                class="mx-2 fa-solid fa-trash hover:cursor-pointer"></i></a>
                    </td>
            ...
            <form action="{{ route('user.delete') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="uk-modal-body">
                    <div class="flex flex-col">
                        ...
                        <h2 class="font-semibold text-center text-red-600 "> voulez vous vraiment supprimer cette
                            utilisateur {{ $user->id }} ?</h2>
