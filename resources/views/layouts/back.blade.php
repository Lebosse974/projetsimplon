        ...
        <nav class="px-6 py-4 bg-white shadow">
            <div class="container flex flex-col mx-auto md:flex-row md:items-center md:justify-between">
                ...
                <div class="flex flex-col md:flex-row md:-mx-4">
                    ...
                    <a class="my-1 text-gray-800 hover:text-blue-500 md:mx-4 md:my-0" href="#">crud user</a>
                    <a class="my-1 text-gray-800 hover:text-blue-500 md:mx-4 md:my-0" href="#">crud communauté</a>
                    <a class="my-1 text-gray-800 hover:text-blue-500 md:mx-4 md:my-0" href="#">crud post</a>
                </div>
                @auth
